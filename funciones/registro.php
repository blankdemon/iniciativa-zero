<?php
	...
	function verificarSesion() {
		...
		if($tiempo_transcurrido >= $timeout) { //si pasaron 10 minutos o más
	...
	function enviarCorreoDeRegistro() {
		...
		$mail->Subject = "Confirmaci�n de Registro";
		...
		$body .= "Bienvenido a Wiki-Global.com<br><br>Inscripci�n  procesada en forma exitosa.<br>";
		$body .= "<br>";
		$body .= "En este correo encontrar� un enlace a T�rminos y Condiciones del sitio para su archivo.<br>";
		$body .= "<br>";
	...
	function registro() {
		...
		if(!comprobar_email($_REQUEST[correo])) $rechazado .= 'La direcci&oacute;n de correo es inv�lida.';
